...
public class Convert {
     ...
     * {@link java.sql.Clob}.
     * For large CLOBs, be careful because this will load an entire CLOB in
     * memory as <code>java.lang.String</code>.
     *
     * @param value
     *            value to convert.
     * @return string representation of an object, including
     *         {@link java.sql.Clob}.
     */
     ...
     * if string type has a value of '1', 't', 'y', 'true' or 'yes'. Otherwise,
     * return false.
     *
     * @param value
     *            value to convert
    ...
    /**
     * Expects a <code>java.sql.Date</code>, <code>java.sql.Timestamp</code>,
     * <code>java.sql.Time</code>, <code>java.util.Date</code>,
     * <code>Long</code> or any object whose toString method has this format:
     * <code>yyyy-mm-dd</code>.
     *
     * @param value
     *            argument that is possible to convert to
        ...
        if (value == null) {
            ...
            try {
                ...
                throw new ConversionException(
                        "failed to convert: '" + value + "' to java.sql.Date",
                        e);
            }
        }
    }
     ...
     * Expects a <code>java.sql.Date</code>, <code>java.sql.Timestamp</code>,
     * <code>java.sql.Time</code>, <code>java.util.Date</code>,
     * <code>Long</code> or string with format "yyyy-MM-dd". This method will
     * truncate hours, minutes, seconds and
     * milliseconds to zeros, to conform with JDBC spec:
     * <a href=
     * "http://download.oracle.com/javase/6/docs/api/java/sql/Date.html">http://
     * download.oracle.com/javase/6/docs/api/java/sql/Date.html</a>.
     *
     * <p>
     ...
     *            <code>java.sql.Timestamp</code>, <code>java.sql.Time</code>,
     *            <code>java.util.Date</code>, <code>Long</code> or any object
     *            with toString() == <code>yyyy-mm-dd</code>.
     * @return <code>java.sql.Date</code> instance representing input value.
     */
    ...
    /**
     * This method will truncate hours, minutes, seconds and milliseconds to
     * zeros, to conform with JDBC spec:
     * <a href=
     * "http://download.oracle.com/javase/6/docs/api/java/sql/Date.html">http://
     * download.oracle.com/javase/6/docs/api/java/sql/Date.html</a>.
     *
     * @param time
     *            time in UTC milliseconds from the epoch
    ...
    /**
     * Converts a <code>java.util.Date</code> to a <code>String</code> in ISO
     * 8601 format: "yyyy-MM-dd'T'HH:mm:ss'Z'"
     * in UTC timezone for timestamps, and "yyyy-MM-dd" for instances of
     * <code>java.sql.Date</code>.
     *
     * <p>
     * This method is tread-safe.
    ...
    public static Double toDouble(Object value) {
        if (value == null) {
            ...
            try {
                ...
                throw new ConversionException(
                        "failed to convert: '" + value + "' to Double", e);
            }
        }
    }

    /**
     * If the value is instance of java.sql.Time, returns it, else tries to
     * convert java.util.Date or Long to
     * Time, else tries to convert using {@link java.sql.Time#valueOf(String)}.
     * This method might trow <code>IllegalArgumentException</code> if fails at
     * conversion.
     *
    ...
    /**
     * If the value is instance of java.sql.Timestamp, returns it, else tries to
     * convert java.util.Date or Long to
    ...
    /**
     * Converts value to Float if it can. If value is a Float, it is returned,
     * if it is a Number, it is
     * promoted to Float and then returned, in all other cases, it converts the
     * value to String,
    ...
    /**
     * Converts value to <code>Long</code> if it can. If value is a
     * <code>Long</code>, it is returned, if it is a <code>Number</code>, it is
     * promoted to <code>Long</code> and then returned, if it is a
     * <code>Date</code>, returns its getTime() value, in all other cases, it
     * converts the value to String,
     * then tries to parse Long from it.
     *
     * @param value
     *            value to be converted to Long.
    ...
    public static Long toLong(Object value) {
        if (value == null) {
            ...
            try {
                ...
                throw new ConversionException(
                        "failed to convert: '" + value + "' to Long", e);
            }
        }
    }

    /**
     * Converts value to Integer if it can. If value is a Integer, it is
     * returned, if it is a Number, it is
     * promoted to Integer and then returned, in all other cases, it converts
     * the value to String,
    ...
    public static Integer toInteger(Object value) {
        if (value == null) {
            ...
            try {
                ...
                throw new ConversionException(
                        "failed to convert: '" + value + "' to Integer", e);
            }
        }
    }

    /**
     * Converts value to BigDecimal if it can. If value is a BigDecimal, it is
     * returned, if it is a BigDecimal, it is
     * promoted to BigDecimal and then returned, in all other cases, it converts
     * the value to String,
    ...
    public static BigDecimal toBigDecimal(Object value) {
        if (value == null) {
            ...
            try {
                ...
                throw new ConversionException(
                        "failed to convert: '" + value + "' to BigDecimal", e);
            }
        }
    }

    /**
     * Converts value to bytes array if it can. If the value is byte array, it
     * is simply returned,
     * if it is a <code>java.sql.Blob</code>, then data is read from it as
     * bytes.
     * In all other cases the object is converted to <code>String</code>, then
    ...
    public static byte[] toBytes(Object value, String ecoding) {
        if (value == null) {
            return null;
        } else if (value instanceof byte[]) {
            return (byte[]) value;
            ...
            try {
                return toString(value).getBytes(ecoding);
    ...
    /**
     * Converts value to Short if it can. If value is a Short, it is returned,
     * if it is a Number, it is
     * promoted to Short and then returned, in all other cases, it converts the
     * value to String,
    ...
    public static Short toShort(Object value) {
        if (value == null) {
            ...
            try {
                ...
                throw new ConversionException(
                        "failed to convert: '" + value + "' to Short", e);
            }
        }
    }
